...
HD_PWD='C:/Users/081230033/Downloads/NRZI/NRZI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nrzi_unipolar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nrzi_unipolar.tcl
