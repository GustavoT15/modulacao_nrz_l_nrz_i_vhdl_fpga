...
HD_PWD='C:/Users/081230033/Downloads/NRZI/NRZI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nrzi_unipolar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nrzi_unipolar.tcl -notrace
