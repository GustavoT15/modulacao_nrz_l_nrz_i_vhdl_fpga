...
HD_PWD='C:/Users/081230033/Desktop/Modules1/NRZL/NRZL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nrzl_unipolar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nrzl_unipolar.tcl -notrace
