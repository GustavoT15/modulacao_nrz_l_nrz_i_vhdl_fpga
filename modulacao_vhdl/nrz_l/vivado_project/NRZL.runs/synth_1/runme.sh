...
HD_PWD='C:/Users/081230033/Desktop/Modules1/NRZL/NRZL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nrzl_unipolar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nrzl_unipolar.tcl
